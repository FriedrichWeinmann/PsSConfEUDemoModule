...
Param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\PSConfEUDemoModule\functions", "$global:testroot\..\PSConfEUDemoModule\internal\functions"),
	
	[string]
	$ModuleName = "PSConfEUDemoModule",
...
$CommandPath = @(
    "$global:testroot\..\PSConfEUDemoModule\functions"
    "$global:testroot\..\PSConfEUDemoModule\internal\functions"
)
