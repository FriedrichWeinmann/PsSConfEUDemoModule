...
Remove-Module PSConfEUDemoModule -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\PSConfEUDemoModule\PSConfEUDemoModule.psd1"
Import-Module "$PSScriptRoot\..\PSConfEUDemoModule\PSConfEUDemoModule.psm1" -Force
